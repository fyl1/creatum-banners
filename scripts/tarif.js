$(document).ready(function () {
    ...
    function crachet() {
        ...
        jQuery(".summarize__line_static ").html("<span>Статичный баннер: " + addSpaces(sum_static) + "</span>");
        jQuery(".summarize__line_dinam ").html("<span>Динамичный баннер: " + addSpaces(sum_dinam) + "</span>");
